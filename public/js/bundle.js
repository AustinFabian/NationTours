      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            // console.log(res)
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " changed succesfully\u2705"));
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              window.setTimeout(function () {
                (0, _alert.showAlert)('success', 'SignedUp Succesfully Now Logg In To Your Account!');
                location.assign('/');
              }, 1500);
            }
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logOut); // FOR UPDATING A USER
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.updateSettings)(form, 'data'); // below still same as as above
